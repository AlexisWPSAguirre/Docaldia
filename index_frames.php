    ...
    <body  style="overflow: hidden;" onload="modalinfo()" id="page-top">
        ...
        <header>
            <div class="row">
                ...
                <div class="col-md-2">
                    <!-- <img src="estilos/orfeo50/imagenes50/sgd.png" class="orf2" alt="Skina technologies"> -->
                </div>
                <div class="col-md-2">
                    ...
                    <ul class="">
                        ...
                        <li class="border-b">
                            <div class="menuUserNom">
                                <span class="glyphicon glyphicon-user"></span> <?= $_SESSION['usua_nomb'] ?>
                            </div>
                        </li>
                        <li class="">
                            <div class="menuUserDepe">
                                <?= $_SESSION['depe_nomb'] ?> <span class="glyphicon glyphicon-home"></span>
                            </div>
                        </li>
                    </ul>
                </nav>
