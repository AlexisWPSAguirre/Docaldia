                    ...
                    <td valign="top"><table width="150"  border="0" cellpadding="0" cellspacing="3" bgcolor="#C0CCCA">
                            ...
                            if ($_SESSION["usua_masiva"] == 1) {
                                ...
                                <tr valign="middle">
                                    ...
                                    <td width="125"><a  onclick="cambioMenu(<?= $i ?>);" href='radsalida/masiva/menu_masiva.php?<?= $phpsession ?>&krd=<?= $krd ?>&<? echo "fechah=$fechah"; ?>'  target='mainFrame' class="collapse-item me02" title="M&oacute;dulo de radicaci&oacute;n masiva" aria-label="M&oacute;dulo de radicaci&oacute;n masiva" alt="M&oacute;dulo de radicaci&oacute;n masiva">Masiva</a></td>
                                </tr>
                                <?php
                            }
                            $i++;
