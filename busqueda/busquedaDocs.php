                        ...
                        <div class="grid-container">
                            ...
                            <div class="seccion1">
                                <div class="seccion1-col1"> 
                                    ...
                                    <section>
                                        <label class="label-filter">  Numero de Expediente </label>
                                        ...
                                        <div class="seccion2-col2">
                                            <section>
                                                ...
                                                <select class="input-form select form-control" name="radi_depe_actu" id="radi_depe_actu">
                                                    <option selected disabled>Seleccione un dependencia</option>
                                                    <?php  foreach($tiposdependencias as $key => $value){ ?>radi_depe_actu
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                        <div class="pull-right">
                            <button type="button" id="botonReasignar" style="font-size: 14px; text-align: center; background-color: #1c4056; border-radius: 10px; width: 25px; width: 145px; color: #ffffff;">Reasignar</button>
                        </div>
                    </div>
                </div>
            </div> -->
