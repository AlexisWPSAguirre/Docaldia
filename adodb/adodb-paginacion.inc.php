...
class ADODB_Pager {
    ...
    var $showPageLinks;
    var $gridAttributes = 'width="100%"  border="1"  cellpadding="0" cellspacing="5" class="borde_tab"';
...
//---------------------------
    ...
    function RenderGrid() {
        ...
        ***/
        ...
        echo "<a href='$dir_raiz/adodb/adodb-xls.inc.php' target='_blank'><img data-toggle='tooltip' data-placement='top' title='". utf8_decode("Exportar contenido del listado como hoja de cálculo") ."' src='$dir_raiz/adodb/spreadsheet.png' width='40' heigth='40' alt='Exportar contenido del listado en formato para excel' border='0' class='mt-2'></a>";
        $s = ob_get_contents();
        ob_end_clean();
        return $s;
    }
