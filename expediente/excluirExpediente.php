    ...
    <body>
        <center>
            <form name='excExp' action='<?php print $encabezado; ?>' method="post">
                ...
                <table width="93%"  border="1" align="center"></table>
                        ...
                        <table border=0 width=93% class="t_bordeGris">
                            <tr class="timparr">
                                ...
                                <td width="50%" height="30" colspan="2" class="listado2"><center>
                                    <input class="botones" type="button" name="Cancelar" id="Cancelar" aria-label="Cerrar ventana" value="CANCELAR" onClick="opener.regresar();
                                    window.close();"></center>  
                                </td>
                            </tr>
                        </table>
                        ...
                        <tr align="center">
                            ...
                            <td width="33%" class="listado2" height="25">
                                <center>
                                    ...
                                    window.close();" aria-label="Cerrar ventana" value=" Cerrar ">
                                </center>
                            </TD>
                        </tr>
                    </table>
        ...
        <span class="etexto"><center></center></span>
    </body>
</html>
