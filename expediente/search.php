...
$sql_nomEx="select distinct sexp.sgd_sexp_parexp1 as SGD_EXP_NOM from sgd_sexp_secexpedientes sexp inner join sgd_exp_expediente exp on sexp.sgd_exp_numero=exp.sgd_exp_numero where upper(sexp.sgd_sexp_parexp1) like '%".$q."%' and sexp.depe_codi='$dependencia' and (exp.sgd_exp_archivo <> 2 or exp.sgd_exp_archivo is null) ORDER BY sexp.sgd_sexp_parexp1";
