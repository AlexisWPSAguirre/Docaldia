...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->SetY(20);
        $this->SetX(45);
        $this->Cell(248, 5, utf8_decode('REGISTRO DE COMUNICACIONES ENVIADAS'), 0, 2, 'C');
        ...
        $this->SetY(40);
        $this->SetX(5);
        $this->Cell(30, 5, utf8_decode('Fecha Radicado'), 1, 0, 'L');
        $this->Cell(25, 5, utf8_decode('No.Radicado'), 1, 0, 'L');
        $this->Cell(50, 5, utf8_decode('Destinatario'), 1, 0, 'L');
        $this->Cell(40, 5, utf8_decode('Dirección'), 1, 0, 'L');
        $this->Cell(50, 5, utf8_decode('Asunto'), 1, 0, 'L');
        $this->Cell(30, 5, utf8_decode('Remitente'), 1, 0, 'L');
        $this->Cell(33, 5, utf8_decode('Fecha/Hora Entrega'), 1, 0, 'L');
        $this->Cell(30, 5, utf8_decode('Firma Recibido'), 1, 2, 'L');
        $this->SetY(45);
        $this->SetX(5);
    }
