...
$mail->SetFrom($usMailSelect, " ".utf8_decode($entidad));
...
$mail->Subject = "Notificacion - Alcaldia Municipal de Tenjo";
...
if($autorizacion == true){
    if ($mail_usu != ' ' or $mail_correcto != 0) {
        ...
        // titulo del correo
        $headMailText = 'Notificaci&oacute;n';
        ...
        $messageContent = "Se registro correctamente su solicitud con el n&uacute;mero Radicado: <b>" . $radicado . "</b>, el cual tiene " . $termino . " d&iacute;as h&aacute;biles para darle respuesta.";
        $messageContent .= '<br><br>Cordialmente,</br><br>Sistema de Gesti&oacute;n Documental Orfeo';
