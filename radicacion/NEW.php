...
//  variables a llenar ene l formulario de radicación.
    ...
    <div class="tabbertab" title="<?= $titulo ?>">
        ...
        if($ent == $tipoRadicadoPqr){
            $cols = "col-lg-6 col-md-6 col-xs-12";
            $displayClass = "block";
        }
        else{
                ...
                <div class="panel-body">
                    <?php if($ent == $tipoRadicadoPqr){ ?>
                        <div class="row">   
                            ...
                            <div class="form-group <?=$cols?>" style="display:<?=$displayClass?>">
                                <label for="fechaQueja">Fecha de la Queja</label><br>
                                <input name="fechaQueja" id="fechaQueja" type="date" title="Fecha de la Queja" class="form-control" value="<?php echo $fechaQueja;?>">
                            </div>
                        </div>
                    <?php } ?>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-3 col-md-3 col-xs-3">
                            ...
                            <input id="fechavencimientorad" type="hidden" class="form-control" title="Ingresar numero de dias de vencimiento del radicado" name="fechavencimientorad"  size="2" readonly="" value="<?=$fechavencimientorad?>">
                        </div>
                        <?php 
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-6 col-md-6 col-xs-12">
                            ...
                            if($ent != 2 and $ent !=$tipoRadicadoPqr and $ent!= 7){
                                echo '<input type="text" class=" form-control" disabled value="'.$usua_nomb.'"/>';
                            }else{
