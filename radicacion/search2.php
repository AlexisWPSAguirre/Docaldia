...
$isql0 = "select TDID_CODI, SGD_CIU_CODIGO, SGD_CIU_NOMBRE, SGD_CIU_DIRECCION, SGD_CIU_APELL1, SGD_CIU_APELL2,SGD_CIU_TELEFONO,SGD_CIU_EMAIL, MUNI_CODI, DPTO_CODI,SGD_CIU_CEDULA, ID_PAIS, ID_CONT,  '' as SGD_CIU_EPS from SGD_CIU_CIUDADANO where ".$sqlWhereisql0;

$isql2 = "select TDID_CODI,  SGD_OEM_CODIGO AS SGD_CIU_CODIGO, SGD_OEM_OEMPRESA as SGD_CIU_NOMBRE, SGD_OEM_DIRECCION as SGD_CIU_DIRECCION, SGD_OEM_SIGLA AS SGD_CIU_APELL1, SGD_OEM_REP_LEGAL as SGD_CIU_APELL2, SGD_OEM_TELEFONO AS SGD_CIU_TELEFONO, EMAIL AS SGD_CIU_EMAIL, MUNI_CODI, DPTO_CODI,SGD_OEM_NIT AS SGD_CIU_CEDULA, ID_PAIS, ID_CONT, '' as SGD_CIU_EPS from SGD_OEM_OEMPRESAS where " .$sqlWhereisql2;

$isql1 = "select ARE_ESP_SECUE AS TDID_CODI,IDENTIFICADOR_EMPRESA AS SGD_CIU_CODIGO,NOMBRE_DE_LA_EMPRESA as SGD_CIU_NOMBRE, DIRECCION as SGD_CIU_DIRECCION, NOMBRE_REP_LEGAL  as SGD_CIU_APELL1, SIGLA_DE_LA_EMPRESA as SGD_CIU_APELL2, TELEFONO_1 AS SGD_CIU_TELEFONO, EMAIL AS SGD_CIU_EMAIL,  CODIGO_DEL_MUNICIPIO as MUNI_CODI, CODIGO_DEL_DEPARTAMENTO as DPTO_CODI, NIT_DE_LA_EMPRESA AS SGD_CIU_CEDULA, ID_CONT,ID_PAIS, '' as SGD_CIU_EPS  from BODEGA_EMPRESAS WHERE ". $sqlWhereisql1;

$isql6 = "select  1  as TDID_CODI, USUA_CODI AS SGD_CIU_CODIGO,usua_nomb as SGD_CIU_NOMBRE, dependencia.dep_direccion as SGD_CIU_DIRECCION, '' as SGD_CIU_APELL1,USUARIO.USUA_LOGIN as SGD_CIU_APELL2, USUARIO.USUA_EXT AS SGD_CIU_TELEFONO, USUARIO.usua_email as SGD_CIU_EMAIL ,dependencia.MUNI_CODI as MUNI_CODI, dependencia.DPTO_CODI as DPTO_CODI,usua_doc AS SGD_CIU_CEDULA,  dependencia.ID_PAIS, dependencia.ID_CONT, '' as SGD_CIU_EPS  from USUARIO, dependencia where USUA_ESTA='1' AND USUARIO.depe_codi = dependencia.depe_codi ".$sqlWhereisql6;
