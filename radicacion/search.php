...
$isql1 = "SELECT  NOMBRE_DE_LA_EMPRESA as USUA_NOMB FROM BODEGA_EMPRESAS  WHERE  ".$sqlWhereisql1;
$isql2 = "SELECT  SGD_OEM_OEMPRESA as USUA_NOMB FROM SGD_OEM_OEMPRESAS  WHERE  ".$sqlWhereisql2;
$isql6 = "SELECT  USUA_NOMB FROM USUARIO  WHERE ".$sqlWhereisql6;
